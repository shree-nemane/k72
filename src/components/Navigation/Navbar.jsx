...
//           }}    
//           className='relative bg-black w-48 h-10 lg:w-64 lg:h-10'>
//               <div ref={navGreenRef} className='bg-[#D3FD50] transition-all duration-300 w-full h-0 top-0 absolute'></div>
//               <div className='relative h-full px-10 flex flex-col justify-center items-end gap-1.5'>
...
const Navbar = () => {
  ...
  if (pageLocation.pathname === "/" || pageLocation.pathname === "/contact") {
    return <HomeNavbar />; // 👈 only for home
  } else if (pageLocation.pathname === "/Agence" || pageLocation.pathname === "/Projects" || pageLocation.pathname === "/blog") {
    return <DefaultNavbar />; // 👈 shared for agency & work
  }

  return null; // no navbar for other pages (optional)
};
